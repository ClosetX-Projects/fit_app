            ...
            <Form {...otpForm}>
              <form onSubmit={otpForm.handleSubmit(onOtpSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor={otpInputId} className="text-center block w-full text-xs font-bold uppercase tracking-widest mb-4">Código de 6 dígitos</FormLabel>
                      <FormControl>
                        <Input 
                          id={otpInputId}
                          name="security-code"
                ...
                <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10 flex gap-3 items-start">
                  ...
                  <p className="text-[11px] text-muted-foreground leading-tight">
                    Nota: No protótipo, o código está no aviso (Toast) no topo.
                  </p>
                </div>
